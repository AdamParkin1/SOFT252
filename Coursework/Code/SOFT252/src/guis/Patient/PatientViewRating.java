...
public class PatientViewRating extends javax.swing.JFrame {

    /**
     * Creates new form MainMenu
     */
    public PatientViewRating() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientViewRating.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientViewRating().setVisible(true);
            }
        });
    }
